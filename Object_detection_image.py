...
print("Boxes: {} classes {}, scores {}, index {}".format(np.squeeze(boxes)[:100],
                                                         np.squeeze(classes)
                                                           .astype(np.int32),
                                                         np.squeeze(scores)[:2],
                                                         category_index))
# Boxes are 100 len where values are more than 0, classes 300, scores 2, index 1
print(len(classes), len(np.squeeze(classes)))
